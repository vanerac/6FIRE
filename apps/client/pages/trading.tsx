            ...
            <div className="trade-inner-header">
                ...
                <div className="container">
                    <div className="content-left box-text">
                        ...
                        <p>
                            Pour voir nos analyses, nos signaux, nos dernières positions et nos avis sur le marché, vous
                            devez obtenir l’accès à notre Telegram ! Pour cela, contactez nous directement via notre
                            Support Telegram ou notre Support WhatsApp
                        </p>
                    </div>
            ...
            <div className="trading-welcome box-text">
                <div className="container-wrap">
                    ...
                    <p>
                        ...
                        besoin. N’hésite pas à nous contacter en cas de questions.
                    </p>
                </div>
            </div>
            {/* Welcome text END */}
                ...
                <div className="left-col">
                    <div className="round-text-wrap">
                        <div className="text">
                            ...
                            <p>
                                Dans cette section tu auras énormément de lecture pour tout apprendre sur la Crypto et
                                sur le Trading. Il faut lire, lire et encore lire pour comprendre, apprendre puis passer
                                à la pratique quand tu es prêt.
                            </p>
                        </div>
                    ...
                    <div className="round-text-wrap forex-wrap">
                        <div className="text">
                            ...
                            <p>
                                Des articles spécifiques au Forex, à l’actualité mondiale et aux conséquences que cela
                                peut engendrer sur les marchés financiers.
                            </p>
                        </div>
                    ...
                    <div className="round-text-wrap nos-trads-wrap">
                        <div className="text">
                            ...
                            <p>
                                Ici, tu peux avoir accès en temps réels aux trades que nous prenons personnellement,
                                avec les analyses de notre outil «secret» qui conforte nos décisions. Pour pouvoir avoir
                                accès à tous nos trades, il faut nous contacter.
                            </p>
                        </div>
                ...
                <div className="right-col">
                    ...
                    <div className="round-text-wrap bot-wrap">
                        ...
                        <div className="text">
                            ...
                            <p>
                                Un outil disponible nul part ailleurs sur le marché ! Nous avons développer un système
                                d’alerte de prises de positions des meilleurs traders de Binance. Tu peux choisir dans
                                le TOP 15 ton trader préféré, et recevoir via Telegram tout ce qu’il fait, à la seconde
                                où il le fait et le copier de A à Z si tu le souhaites !
                            </p>
                        </div>
                    </div>
                </div>
