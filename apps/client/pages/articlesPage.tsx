        ...
        <body style={{ margin: 0, background: '#ffffff' }}>
            ...
            <div className="homepage-1 screen">
                <div className="footer-58RGA4">
                    ...
                    <div className="logo-oAP47k">
                        <div className="groupe-2-sl8fJD">
                            <img className="groupe-1-Im0Mvz" src="img/group-1-11@1x.png" />
                        </div>
                        <img className="effect-sl8fJD" src="img/effect-12@1x.png" />
                    </div>
                    <img className="ligne-31-oAP47k" src="img/line-31-1@1x.png" />
                    <div className="groupe-3011-oAP47k">
                        <img className="icon-instagram-fzzB9m" src="img/fontawsome--instagram--1@1x.png" />
                    </div>
                    <div className="groupe-3010-oAP47k">
                        <img className="icon-simple-tiktok-IkA9hE" src="img/icon-simple-tiktok-1@1x.png" />
                    </div>
                </div>
                    ...
                    <div className="content-dark-LZQy1P">
                        ...
                        <div className="prvisualition-articles-1CdAvu">
                            <div className="article-zyelmY">
                                <img className="groupe-de-masques-321-QWNatB" src="img/mask-group-321-2@1x.png" />
                                <div className="club-premium-QWNatB lato-normal-milano-red-12px">Play to Earn</div>
                                <img className="ligne-12-QWNatB" src="img/line-12-1@1x.png" />
                            ...
                            <div className="article-imAGBk">
                                <img className="groupe-de-masques-322-GGqLgC" src="img/mask-group-322-2@1x.png" />
                                ...
                                <img className="ligne-33-GGqLgC" src="img/line-12-1@1x.png" />
                                <div className="club-premium-BC63SN lato-light-manatee-12px">Il y a 2 heures</div>
                            </div>
                            <div className="article-k5qTpB">
                                <img className="groupe-de-masques-323-XPBk3x" src="img/mask-group-323-1@1x.png" />
                                <div className="club-premium-XPBk3x lato-normal-grenadier-12px">Crypto</div>
                                <img className="ligne-14-XPBk3x" src="img/line-12-1@1x.png" />
                            ...
                            <div className="article-A8GUxd">
                                <img className="groupe-de-masques-324-oX14gz" src="img/mask-group-324-1@1x.png" />
                                <div className="club-premium-oX14gz lato-normal-milano-red-12px">Entreprenariat</div>
                                <img className="ligne-15-oX14gz" src="img/line-12-1@1x.png" />
                                ...
                                <img className="icon-twitter-oX14gz" src="img/image-874-1@1x.png" />
                                <div className="rectangle-3502-oX14gz"></div>
                            </div>
                            <div className="article-5ppYHv">
                                <img className="groupe-de-masques-325-Q7nH9g" src="img/mask-group-325-1@1x.png" />
                                <div className="rectangle-3503-Q7nH9g"></div>
                                <div className="club-premium-Q7nH9g lato-normal-milano-red-12px">Crypto</div>
                                <img className="ligne-16-Q7nH9g" src="img/line-12-1@1x.png" />
                                ...
                                <img className="rectangle-3499-Q7nH9g" src="img/rectangle-3499-1@1x.png" />
                            ...
                            <div className="article-GMoPzx">
                                <img className="groupe-de-masques-321-dNsLE7" src="img/mask-group-321-1@1x.png" />
                                <div className="club-premium-dNsLE7 lato-normal-milano-red-12px">Crypto</div>
                                <img className="ligne-12-dNsLE7" src="img/line-12-1@1x.png" />
                            ...
                            <div className="article-VRP5KA">
                                <img className="groupe-de-masques-322-xCffPl" src="img/mask-group-322-1@1x.png" />
                                <div className="club-premium-xCffPl lato-normal-milano-red-12px">Crypto</div>
                                <img className="ligne-13-xCffPl" src="img/line-12-1@1x.png" />
                            ...
                            <div className="article-WXQx0A">
                                <img className="groupe-de-masques-323-h1i8tL" src="img/mask-group-323-1@1x.png" />
                                <div className="club-premium-h1i8tL lato-normal-milano-red-12px">Crypto</div>
                                <img className="ligne-14-h1i8tL" src="img/line-12-1@1x.png" />
                        ...
                        <div className="button-signin-1CdAvu">
                            ...
                            <img
                                className="icon-ionic-ios-arrow-forward-XhTuob"
                ...
                <div className="header-58RGA4">
                    ...
                    <div className="logo-qecRh8">
                        <img className="effect-5nR13k" src="img/effect-13@1x.png" />
                    </div>
                    <div className="menu-qecRh8">
                        ...
                        <div className="cryptommonnaies-R5LSYq">
                            ...
                            <div className="icon-actif-rofYOU">
                                <img className="groupe-1490-2aycJd" src="img/group-1490-1@1x.png" />
                            </div>
                        </div>
                        <div className="nft-R5LSYq">
                            ...
                            <div className="icon-PNeNRG">
                                ...
                                <img className="nft-Q6aYQM" src="img/nft-1@1x.png" />
                            </div>
                        </div>
                        <div className="play-to-earn-R5LSYq">
                            ...
                            <div className="icon-pcy4yC">
                                ...
                                <div className="gamepad-ti8Jhx">
                                    <img className="trac-1021-P5lkcx" src="img/path-1021-1@1x.png" />
                                </div>
                            </div>
                        </div>
                        <div className="immobiler-R5LSYq">
                            ...
                            <div className="icon-qnUGH1">
                                ...
                                <div className="groupe-1502-WR19dA">
                                    <img className="groupe-1504-1uxZ3P" src="img/group-1504-1@1x.png" />
                                </div>
                            </div>
                        </div>
                        <div className="e-commerce-R5LSYq">
                            ...
                            <div className="icon-fftvIH">
                                ...
                                <img className="website-Qw8ovD" src="img/website-1@1x.png" />
                            </div>
                        </div>
                    ...
                    <div className="menu-2-qecRh8">
                        <div className="icon-ionic-ios-menu-HLXizF">
                            <img className="trac-1-QKxW1t" src="img/path-1-10@1x.png" />
                            <img className="trac-2-QKxW1t" src="img/path-2-10@1x.png" />
                        </div>
                    </div>
                    <div className="toogle-button-qecRh8">
                        <img className="icon-ionic-ios-moon-TBfV2N" src="img/icon-ionic-ios-moon-1@1x.png" />
                    ...
                    <div className="search-bar-qecRh8">
                        <img className="icon-search-lJwrC9" src="img/icon-ionic-ios-search-11@1x.png" />
                    </div>
                </div>
                <div className="call-to-action-58RGA4">
                    <img className="groupe-de-masques-328-ir0Byo" src="img/mask-group-328@1x.png" />
                ...
                <div className="avertissement-58RGA4">
                    ...
                    <img className="ligne-41-yrWeSQ" src="img/line-41-2@1x.png" />
                </div>
            </div>
            <div className="homepage-1-mobile screen">
                ...
                <div className="logo-3xxVvY">
                    <img className="effect-Xi5pKN" src="img/effect-47@1x.png" />
                </div>
                <div className="toogle-button-3xxVvY">
                    <img className="icon-ionic-ios-moon-kRajWn" src="img/icon-ionic-ios-moon-15@1x.png" />
                ...
                <div className="search-bar-3xxVvY">
                    <img className="icon-search-aHekTv" src="img/icon-ionic-ios-search-27@1x.png" />
                </div>
                <div className="article-3xxVvY">
                    <img className="groupe-de-masques-321-6aK4Nx" src="img/groupe-de-masques-321-16@1x.png" />
                    <div className="club-premium-6aK4Nx lato-normal-milano-red-12px">Play to Earn</div>
                    <img className="ligne-12-6aK4Nx" src="img/line-12-1@1x.png" />
                ...
                <div className="article-HB3jNP">
                    <img className="groupe-de-masques-322-bL8f3T" src="img/groupe-de-masques-322-16@1x.png" />
                    ...
                    <img className="ligne-33-bL8f3T" src="img/line-12-1@1x.png" />
                    <div className="club-premium-AbUI9a lato-light-manatee-12px">Il y a 2 heures</div>
                </div>
                <div className="call-to-action-3xxVvY">
                    <img className="groupe-de-masques-328-VYlZcy" src="img/groupe-de-masques-328-1@1x.png" />
                ...
                <div className="article-hgxJDx">
                    <img className="groupe-de-masques-323-1oVcqO" src="img/groupe-de-masques-323-16@1x.png" />
                    <div className="club-premium-1oVcqO lato-normal-grenadier-12px">Crypto</div>
                    <img className="ligne-14-1oVcqO" src="img/line-12-1@1x.png" />
                ...
                <div className="article-H87bfg">
                    <img className="groupe-de-masques-324-nUO7eE" src="img/groupe-de-masques-324-5@1x.png" />
                    <div className="club-premium-nUO7eE lato-normal-milano-red-12px">Entreprenariat</div>
                    <img className="ligne-15-nUO7eE" src="img/line-12-1@1x.png" />
                    ...
                    <img className="icon-twitter-nUO7eE" src="img/image-874-1@1x.png" />
                    <div className="rectangle-3502-nUO7eE"></div>
                </div>
                <div className="menu-3xxVvY">
                    <div className="icon-ionic-ios-menu-uexWkk">
                        <img className="trac-1-lDeg6M" src="img/path-1-10@1x.png" />
                        <img className="trac-2-lDeg6M" src="img/path-2-10@1x.png" />
                    </div>
                </div>
                <div className="article-DxJEuX">
                    <img className="groupe-de-masques-325-IdhFt5" src="img/groupe-de-masques-325-3@1x.png" />
                    <div className="rectangle-3503-IdhFt5"></div>
                    <div className="club-premium-IdhFt5 lato-normal-milano-red-12px">Crypto</div>
                    <img className="ligne-16-IdhFt5" src="img/line-12-1@1x.png" />
                    ...
                    <img className="rectangle-3499-IdhFt5" src="img/rectangle-3499-1@1x.png" />
                ...
                <div className="button-signin-3xxVvY">
                    ...
                    <img
                        className="icon-ionic-ios-arrow-forward-QAxT4p"
                        src="img/icon-ionic-ios-arrow-forward-2@1x.png"
                    />
                </div>
                ...
                <div className="footer-3xxVvY">
                    ...
                    <div className="logo-iBHDxC">
                        <div className="groupe-2-RxRKlm">
                            <img className="groupe-1-svM4hW" src="img/group-1-11@1x.png" />
                        </div>
                        <img className="effect-RxRKlm" src="img/effect-12@1x.png" />
                    </div>
                    <img className="ligne-31-iBHDxC" src="img/ligne-31-14@1x.png" />
                    <div className="groupe-3011-iBHDxC">
                        <img className="icon-instagram-dU5Nvw" src="img/fontawsome--instagram--1@1x.png" />
                    </div>
                    <div className="groupe-3010-iBHDxC">
                        <img className="icon-simple-tiktok-DfizfW" src="img/icon-simple-tiktok-1@1x.png" />
                    </div>
                    <img className="icon-paper_plane-iBHDxC" src="img/icon-awesome-telegram-plane-1@1x.png" />
                </div>
                <img className="ligne-41-3xxVvY" src="img/ligne-41-15@1x.png" />
            </div>
        </body>
    );
};
