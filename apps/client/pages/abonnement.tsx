            ...
            <Header isOpenSideBar={props.useStateOpenSideBar} isEspaceTradingCrypto={false} />
                <div className="account-wrapper">
                    ...
                    <div className="main-title">
                        <h1 className="title">Abonnement et paiement<span>Gérez, modifiez votre abonnement et vos informations de paiement</span></h1>
                    </div>

                    <div className="price-cart">
                        <div className="cart">
                            <div className="title">Novice <span>(Pour les débutants/frileux)</span></div>
