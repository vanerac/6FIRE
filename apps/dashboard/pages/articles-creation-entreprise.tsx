                ...
                <div className="articles-creer-un-article-1 screen">
                    ...
                    <div className="articles-ac2OFL">
                        ...
                        <div className="nom-GiT5tA">
                            <div className="image-prsentation-FTRSfD lato-normal-comet-10px">Image Présentation</div>
                        ...
                        <div className="filtre-GiT5tA">
                            ...
                            <div className="name-hMV91R poppins-medium-mirage-10px">Thèmes articles</div>
                            <img
                        ...
                        <div className="id-fixe-GiT5tA">
                            ...
                            <div className="thme-slectionn-Tx5c37 lato-normal-comet-10px">Thème sélectionné</div>
                        </div>
                    ...
                    <div className="articles-editeur-ac2OFL">
                        ...
                        <div className="description-Gc4Wti">
                            ...
                            <div className="axie-infinity-est-un-eM9KJG poppins-normal-vulcan-12px">
                                Axie Infinity est un univers d’animaux de compagnie numérique décentralisé où les
                                joueurs combattent, élèvent et échangent des créatures fantastiques appelées Axies. Les
                                joueurs gagnent des revenus sous la forme de jetons fongibles appelés Smooth Love
                        ...
                        <div className="tarification-Gc4Wti">
                            ...
                            <div className="pour-jouer-axie-infi-hMApAB poppins-normal-vulcan-12px">
                                Pour jouer à Axie Infinity, un joueur doit d’abord acheter une équipe de trois Axies,
                                qui sont eux-mêmes des jetons non fongibles (NFT).
                                <br />
                                <br />
                    ...
                    <div className="articles-suggrs-ac2OFL">
                        ...
                        <div className="filtre-j2vd34">
                            ...
                            <div className="name-9xzvgX poppins-medium-mirage-10px">Thèmes articles</div>
                            <img
                    ...
                    <div className="sidebar-ac2OFL">
                        ...
                        <div className="thmes-articles-8G8P7W">
                            <div className="name-gH36E0 poppins-medium-mirage-14px">Thèmes articles</div>
                        ...
                        <div className="articles-8G8P7W">
                            ...
                            <div className="name-h20q2x poppins-medium-blue-ribbon-14px">Créer article</div>
                            <div className="name-F98axI poppins-medium-blue-ribbon-14px">Créer article entreprise</div>
